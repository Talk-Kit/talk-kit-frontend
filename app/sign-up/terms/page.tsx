      ...
      <div className="flex w-full px-4 py-8 flex-col items-center gap-6 self-stretch">
        ...
        <div className="flex w-full max-w-[600px] flex-col items-start gap-4">
          ...
          <div className="flex h-[120px] py-2 px-4 items-start gap-2 self-stretch border-[1px] border-gray-3 overflow-scroll hide-scrollbar">
            ...
            sed efficitur nulla, eget varius arcu. Phasellus auctor massa vel
            turpis imperdiet posuere id a metus. Nulla elementum scelerisque
            elit, non bibendum lacus ornare eu. Cras dignissim aliquam nulla ut
            porta. Fusce pulvinar sed sem sed aliquet. Vivamus nisl nunc,
            vulputate eu sem sit amet, viverra dictum mauris. Curabitur eget
            nunc ultricies, tincidunt arcu sed, auctor enim. Vivamus elementum
            tincidunt dapibus. Vivamus tincidunt ex nec massa commodo auctor.
            Cras ultricies posuere dolor efficitur pharetra.
          </div>
        </div>
